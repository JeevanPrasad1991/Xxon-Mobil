    ...
    public void uploadDataWithoutWait(final ArrayList<String> keyList,
        ...
        try {
            ...
            if (ex != null) {
                ...
                AlertandMessages.showAlert((Activity) context, "failure Please try again ", true);
            }
        ...
        try {
            ...
            if (totalFiles == uploadedFiles) {
                ...
                if (e != null) {
                    ...
                    AlertandMessages.showAlert((Activity) context, CommonString.KEY_FAILURE + "  .Please try again.", true);
                }
            }
        }
                                ...
                                try {
                                    ...
                                    if (data.equals("")) {
                                        ...
                                        if (data.contains("1")) {
                                            status_u[0] = true;
                                            db.open();
                                            db.updateJaurneyPlanSpecificStoreStatus(finalStore_data.get(0).getStoreId().toString(), finalStore_data.get(0).getVisitDate(), status);
                                            db.updateJaurneyPlanPosmEditableStatus(finalStore_data.get(0).getStoreId().toString(), finalStore_data.get(0).getVisitDate(), CommonString.KEY_STATUS_N);
